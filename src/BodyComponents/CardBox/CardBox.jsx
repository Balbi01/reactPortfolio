function CardBox ({
    ...
    return (
        <div className="sm:max-w-96 max-w-72 border flex flex-col justify-center rounded-xl items-center mt-6 mb-2">
            <div>
            ...
            <div className="flex flex-col bg-transparent">
                ...
                <div className="flex justify-between p-6">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 264" width="2.5em" height="2.5em">
                    ...
                    <button className="bg-amber-500 h-8 w-24 rounded-lg self-end">
                        <p>{buttonTitle}</p>
                    </button>
                </div>
            </div>
