        ...
        <div className="main-body-style">
            <div id="portfolio-template" className="portfolio-template">
                ...
                <div id="body" className="main-template-body-phone">
                    ...
                    <div id="title-photo" className="title-photo-phone">
                        ...
                        <div id="title" className="main-titlename-phone">
                            <div className="btnTest">
                                <h1 className="principalUserName">David <br/><span className="text-amber-500 lg:ml-4">Ibañez</span></h1>
                            </div>
                    ...
                    <div className="flex flex-row text-xl mt-12 md:mt-6 md:mb-12 justify-center md:justify-end md:mr-48">
                        <button onClick={handleLinkedinClick} id="contact-me" className="contact-buttons-style" tabIndex={0}>
                        ...
                        <button onClick={handleGithubClick} id="contact-me" className="contact-buttons-style">
                            <svg className="h-12 w-12 mr-2 fill-white"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
                    ...
                    <div id="about-me" className="max-w-96 self-center md:max-w-96 lg:max-w-2xl md:px-0 md:self-center flex flex-col w-full px-8 py-8">
